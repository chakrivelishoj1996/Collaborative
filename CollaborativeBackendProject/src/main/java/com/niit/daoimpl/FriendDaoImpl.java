...
@Autowired
	...
	public List<User> getAllSuggestedUsers(String email) {
		...
		String queryString="select * from user_s191174100104 where email "
				+ "in "
				+ "(select email from user_s191174100104 where email!=:e3 "
				+ "minus "
				+ "(select fromid_email from friend_s191174100104 where  toid_email=:e1 "
				+ "union "
				+ "select toid_email from friend_s191174100104 where fromid_email=:e2))";
